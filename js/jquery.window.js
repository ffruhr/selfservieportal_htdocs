...
// removed in jquery 1.9(Chrisno)			if( !$.browser.msie && caller == null ) { // in IE, must do hide scrollbar routine after animation finished
//			if(navigator.userAgent.match(/msie [6]/)) { //Anpassung für aktuelles jquery (Chrisno)
...
//					height: $('body').height() -10,
			...
			if( bImmediately ) {
				...
				hideContent();
				container.animate(targetCssStyle, setting.animationSpeed, 'swing', function() {
// entfernt in jquery 1.9(Chrisno)					if( $.browser.msie && caller == null ) { // in IE, must do hide scrollbar routine after animation finished
					if(navigator.userAgent.match(/msie [6]/)) { // anpassung für aktuelles jquery(Chrisno)
						hideBrowserScrollbar();
					}
					showContent();
